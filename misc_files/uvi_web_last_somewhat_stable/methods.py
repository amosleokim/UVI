...
def get_themrole_fields(class_id, frame_desc, themrole_name):
	themrole_name_stripped = themrole_name.strip('?').strip('_i').strip('_j').strip('Co-')
	return db.vn_themrole_fields.find_one({'class_id': class_id, 'frame_desc': frame_desc, 'themrole_name': themrole_name_stripped})
